...
public abstract class BaseDbAssert<S extends BaseDbAssert<S, A>, A extends BaseDao>
    ...
    protected BaseDbAssert<S, A> dateCreatedEquals(LocalDateTime expected) {
        isEqualTo(actual.getCreatedAt(), expected, String.format("Expected date created %s but was %s", expected, actual.getCreatedAt()));
        return this;
    }

    protected BaseDbAssert<S, A> dateUpdatedEquals(LocalDateTime expected) {
        isEqualTo(actual.getUpdatedAt(), expected, String.format("Expected date updated %s but was %s", expected, actual.getUpdatedAt()));
        return this;
    }
